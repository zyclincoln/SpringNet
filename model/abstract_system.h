...
namespace zyclincoln{
  ...
  class AbstractSystem{
    ...
    virtual Eigen::MatrixXd delta_potential_energy_matrix() = 0;
    ...
    virtual void update_velocity_vector(Eigen::VectorXd &velocity) = 0;
    virtual void update_position_vector(Eigen::VectorXd &position) = 0;
  }
